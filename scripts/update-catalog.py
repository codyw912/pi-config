...
EXTENSION_PURPOSES = {
    ...
    "project-commands.ts": "Slash commands for project cockpit/planning workflows: `/project-init`, `/project-status`, `/project-roadmap`, `/project-deepen`, `/project-chunk`, `/project-wrap`, and `/project-momentum`.",
